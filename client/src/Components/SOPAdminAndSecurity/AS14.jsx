...
import './AS14.css'; // Assuming the new CSS file for this component is AS14.css

const MaterialOutRegister = () => {
  ...
  return (
    <div className="material-out-register-container">
      <form onSubmit={handleSubmit}>
        <h3 className="form-heading">MATERIAL OUT REGISTER</h3>
...
export default MaterialOutRegister;
